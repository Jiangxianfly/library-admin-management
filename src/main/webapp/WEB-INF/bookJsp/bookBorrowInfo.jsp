...
<div class="row">
    ...
    <div class="col-sm-3">
        <a href=""><span class="glyphicon glyphicon-save">&nbsp<span>导出Excel表</span></span></a>
    </div>
</div>
<br/>
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)"
                       onclick="if(confirm('你确定删除?')){location.href='<%=basePath%>/borrow/deleteBorrow?id=${borrow.borrowID }&rdID=${borrow.rdID }&bkID=${borrow.bkID }&isHasReturn=${borrow.isHasReturn }'; window.reload();}"><span
