    ...
    <table class="table table-striped table-hover ">
        ...
        <c:forEach items="${bookClassList }" var="bookClass">
            <tr>
                ...
                <td><a href="<%=basePath%>/bookClass/editBookClass?rdID=${bookClass.bkCatalog}&start=${start}"><span
                        class="glyphicon glyphicon-edit"></span></a>
                    <a href="javascript:void(0)"
                       onclick="if(confirm('你确定删除?')){location.href='<%=basePath %>/bookClass/deleteBookClass?start=${start }&bkCatalog=${bookClass.bkCatalog }'; window.reload();}"><span
